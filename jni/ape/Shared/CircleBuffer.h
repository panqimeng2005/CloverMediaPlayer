...
public:
    ...
    // direct writing
    // panqimeng add for compile __forceinline unsigned char * CCircleBuffer::GetDirectWritePointer()
    ...
    // panqimeng modify for compile __forceinline void CCircleBuffer::UpdateAfterDirectWrite(int nBytes)
